...
const AddEmployee = () => {
  ...
  useEffect(() => {
    const fetchAvailableEmployees = async () => {
      setLoading(true);
      try {
        const res = await axios.get("/api/users/available-employees");
            ...
            return {
              ...
              name:
                clerkUser.first_name && clerkUser.last_name
                  ...
                  : emp.email.split("@")[0],
              initials:
                clerkUser.first_name?.charAt(0).toUpperCase() +
                (clerkUser.last_name?.charAt(0).toUpperCase() || ""),
  ...
  return (
    <Grow in>
      <Box sx={{ p: 4, minHeight: "100vh", bgcolor: "#f9fafb", position: "relative" }}>
        <IconButton
          onClick={() => navigate("/manager?tab=0")}
        ...
        {loading ? (
          ...
          <>
            <Paper
              elevation={3}
              sx={{ borderRadius: 3, maxWidth: 700, mx: "auto", p: 2 }}
            >
              <List>
                              ...
                              secondary={
                                <Box mt={1}>
                                  ...
                                  <Stack direction="row" spacing={2} mt={1.5}>
                                    <Chip
                                      label={`${employee.pendingTasks} pending tasks`}
                                      variant="outlined"
                                      size="small"
                                    />
                                    <Chip
                                      label={`${employee.completedTasks} completed`}
                                      variant="outlined"
                                      size="small"
                                      color="success"
                                    />
